...
6. Browser → exported evidence file
7. Future external telemetry/routing systems → Lifeline adapters
8. Future Lifeline service → vehicles, facilities, and incident-management systems
